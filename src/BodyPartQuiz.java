...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		JOptionPane.showMessageDialog(null, "guess the celebrity's first name(all lowercase)");
		initializeGui();
		for (int i = 0; i < 4; i++) {
			...
			// -- Tell them they are wrong and who the person is
				...
				JOptionPane.showMessageDialog(null, "Incorrect, it's arnold");
			}
			...
			if(guess.equals("leonardo") & i==1) {
				...
				JOptionPane.showMessageDialog(null, "Incorrect, it's leonardo");
			}
			if(guess.equals("morgan") & i==2) {
				...
				JOptionPane.showMessageDialog(null, "Incorrect, it's morgan");
			}
			if(guess.equals("jack") & i==3) {
				...
				JOptionPane.showMessageDialog(null, "Incorrect, it's jack");
			}
